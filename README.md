...
## 功能现状（M0–M19 已完成，里程碑详见 [docs/PRD.md](./docs/PRD.md) §28）
...
M8 体验优化已全部完成（搜索高亮 / 状态徽章 / 大文本折叠 / 错误提示 / 排序分页 / 统一导航 / 最近打开 / 向量状态卡片）。后续里程碑（M9 文档解析 / M10 EPUB / M11 sidecar 目录 / M12 转录分段视图 / M13 播放器与字幕跳转 / M14 混合搜索排序 / M15 标签系统 / M16 AI 建议标签 / M17 批量任务 / M18 深度分析 / M19 资产列表文件夹层级浏览）均已落地，下一步规划见 [docs/PRD.md](./docs/PRD.md) §31。
